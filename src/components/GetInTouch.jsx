  ...
  return (
    <div className='bg-[#0f172a] pt-20px'>
      <div className='container mx-auto '>
        <div className='grid grid-cols-1 md:grid-cols-2 py-20  gap-6'>
      ...
      <div>
            <a class="px-btn px-btn-theme px-btn-contact">SEND MESSAGE</a>
          </div>
          ...
          <div className='w-full flex justify-end '>
            ...
            <div className='flex text-black bg-[#9BD3D0]  justify-center items-center w-[70px] h-[70px] '>
            <i class="fas fa-envelope text-[30px]"></i>
            
        </div>
            <div className='flex flex-col gap-2 justify-start items-start'>
                <h5 className='text-base uppercase font-semibold text-gray-300'>Phone</h5>
                <p className='text-[#FFFFFF] text-lg font-bold '>+01 123 654 8096</p>
            </div>


            </div>
            <div className='flex justify-start items-center gap-4 pt-8'>
            <div className='flex text-black bg-[#FEC447]  justify-center items-center w-[70px] h-[70px] '>
            <i class="fas fa-solid fa-phone text-[30px]"></i>
            
        </div>
            <div className='flex flex-col gap-2 justify-start items-start'>
                <h5 className='text-base uppercase font-semibold text-gray-300'>MAIL</h5>
                <p className='text-[#FFFFFF] text-lg font-bold '>info@domainname.com</p>
            </div>


            </div>
            <div className='flex justify-start items-center gap-4 pt-8'>
            <div className='flex text-black bg-[#FECCB5]  justify-center items-center w-[70px] h-[70px] '>
            <i class="fas fa-map-marker-alt text-[30px]"></i>
            
        </div>
            <div className='flex flex-col gap-2 justify-start items-start'>
                <h5 className='text-base uppercase font-semibold text-gray-300'>Visit My Studio</h5>
                <p className='text-[#FFFFFF] text-lg font-bold '>Warnwe Park Streetperrine,
