...
const Projects = () => {
  return (
    <div className='bg bg-[rgb(255,247,237)] bg-opacity-100 pt-32'>

      <div className='container mx-auto '>
        <h3 className='uppercase text-center text-5xl font-bold pb-20'>Latest Projects</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-4 pb-20 ">
            ...
            <div className='flex flex-col justify-start items-start  gap-6'>
                ...
                <h3 className='text-[#0F172A] text-4xl font-semibold' >Website Design for Marketing Agency Startup</h3>
